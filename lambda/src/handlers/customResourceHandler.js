...
async function handle(event, dependencies) {
  ...
  if (event.RequestType === 'Create' || event.RequestType === 'Update') {
    ...
    const html = generateInitialStatusPage(SERVICE_NAME, SERVICE_URL, DATA_RETENTION_DAYS, CLOUDFRONT_DISTRIBUTION_ID);
...
function generateInitialStatusPage(serviceName, serviceUrl, dataRetentionDays, cloudFrontDistributionId) {
...
<head>
    ...
    <link rel="alternate" type="application/rss+xml" title="${serviceName} Status Updates" href="${rssUrl}">
</head>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex items-center justify-between">
                <p class="text-sm text-gray-600">
                    Last updated: ${timestamp} | Data retained for ${dataRetentionDays} days
                </p>
